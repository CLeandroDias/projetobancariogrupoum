...
-- -----------------------------------------------------
-- Table `Banco`.`ContaCorrente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Banco`.`ContaCorrente` (
  ...
  INDEX `fk_ContaCorrente_Agencia1_idx` (`IdAgencia` ASC) VISIBLE,
  CONSTRAINT `fk_ContaCorrente_Agencia1`
    FOREIGN KEY (`IdAgencia`)
    REFERENCES `Banco`.`Agencia` (`IdAgencia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Banco`.`Cliente` (
  ...
  INDEX `fk_Cliente_ContaCorrente1_idx` (`IdContaCorrente` ASC, `IdAgencia` ASC) VISIBLE,
  CONSTRAINT `fk_Cliente_ContaCorrente1`
    FOREIGN KEY (`IdContaCorrente` , `IdAgencia`)
    REFERENCES `Banco`.`ContaCorrente` (`IdContaCorrente` , `IdAgencia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Banco`.`Extrato` (
  ...
  INDEX `fk_Extrato_ContaCorrente1_idx` (`IdContaCorrente` ASC) VISIBLE,
  CONSTRAINT `fk_Extrato_ContaCorrente1`
    FOREIGN KEY (`IdContaCorrente`)
    REFERENCES `Banco`.`ContaCorrente` (`IdContaCorrente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
